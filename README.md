...
### YT-DLP API - YouTube Information Extractor
A FastAPI-based service providing optimized YouTube video information extraction with integrated Telegram bot for token management and rate limiting.

**Technologies**: FastAPI, Python, yt-dlp, Redis, Pyrogram, Docker  
**Features**:
- Fast video info extraction with Chrome cookie support
- Token-based authentication system
- Rate limiting (1000 requests/day for users, 10000 for admins)
- Free unlimited search functionality
- Interactive Telegram bot for API token management
